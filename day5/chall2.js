...
fs.readFile('./day5/input.txt', 'utf8', (err, data) => {
    ...
    //For some reason the seeds didn't let themselves be saved directly into the seedsTemp variable so I copied the result['seeds'] variables into it and then redeclared it, I don't care anymore at this point I'm fucking fed up with this shit let me go to bed for fucks sake
    var seedsTemp = result['seeds'];
    result['seeds'] = [];
